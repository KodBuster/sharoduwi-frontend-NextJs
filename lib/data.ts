...
export const REVIEWS: {
...
}[] = [
  {
    ...
    city: "ул. Чкалова, 6",
    rating: 5,
    text: "Огромное спасибо магазину за праздник! Выбор просто невероятный: столько разных цветов, размеров и крутых фигур, что глаза разбегаются. Найти именно то, что хотели, было очень легко. Ребята — профессионалы, помогли с композицией. Теперь за шариками только к вам!",
  },
  {
    initial: "К",
    color: "var(--sky)",
    ...
    city: "ул. Чкалова, 6",
    rating: 5,
    text: "Магазин «Шародувы» оставил очень приятное впечатление. Большой выбор товаров, всё аккуратно оформлено, а сотрудники вежливые и помогают с выбором. Заказ выполнили быстро, качество отличное. Осталась довольна покупкой, обязательно обращусь снова!",
  },
  {
    initial: "М",
    color: "var(--mint)",
    ...
    city: "ул. Чкалова, 6",
    rating: 5,
    text: "Чудесное место! Заказываю здесь шары не первый год! Очень клиентоориентированный и вежливый персонал! Шары стоят 2–3 недели! Сегодня готовлюсь к 18-летию сына.",
  },
  {
    initial: "Е",
    color: "var(--coral)",
    ...
    city: "ТЦ «Фермер»",
    rating: 5,
    text: "Отличное место для выбора всего для праздника. Шары, тарелки, свечи, открытки. Девушка отзывчивая, помогает с выбором. Рекомендую!",
  },
  {
    initial: "С",
    color: "var(--sun)",
    ...
    city: "ТЦ «Фермер»",
    rating: 5,
    text: "Отличные шары, очень понравилось. Красиво, быстрая доставка, любезные продавцы, всё сделали вовремя и точно по запросу. Большой выбор шаров на любое торжество.",
  },
  {
    initial: "В",
    color: "var(--lav)",
    ...
    city: "ТЦ «Фермер»",
    rating: 5,
    text: "Отличное место, вежливый персонал! Частенько покупаем товары к празднику! Большой выбор шариков, свечей и всего необходимого для красочного праздника и хорошего настроения.",
  },
];
